...
public class ThongTinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng nhacuaVanThanh = new LatLng(20.979041, 105.785651);
        mMap.addMarker(new MarkerOptions().position(nhacuaVanThanh).title("Marker in Sydney").icon(BitmapDescriptorFactory.defaultMarker()));
        mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        CameraPosition cameraPosition = new CameraPosition.Builder().target(nhacuaVanThanh).zoom(90).build();
